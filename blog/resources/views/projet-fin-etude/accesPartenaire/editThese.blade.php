...
@endif
  ...
  @if($profil =="admin" || $userCurrent =="bon")
    <div class="w3-light-grey w3-padding-64 w3-margin-bottom w3-center d-flex flex-wrap" >
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div style="margin-top:28px"><a href="/Accueil/Acces-Partenaire"><i class="fa fa-mail-reply" style="font-size:48px;"></i></a></div>
...
<div class="w3-row-padding w3-content" style="max-width:1400px">
  ...
  <div class="w3-third">
    <div class="w3-container  w3-justify" id="edito1" style="background-color:{{$couleur->clor_obj}}">
    <div>
      <h2>Obectifs</h2>
