...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:250px;" id="mySidebar">
  ...
  <button class="w3-bar-item w3-button" id="event" onclick="editActualite(this.id)">Modifier Evenenement</button>
  <button class="w3-bar-item w3-button" onclick="addNewActualite()">Ajouter Evenenement</button>
  <button class="w3-bar-item w3-button" id="delete" onclick="displaydeleteOneActualite(this.id)">Supprimer Evenenement</button>
    ...
    <div class="chat-search-box w3-right" id="contentSearch">
        ...
        <div class="input-group">
            ...
            <div class="input-group-btn">
               <button type="button" class="btn btn-info w3-light-blue" id= "event" onclick="getOneActualite(this.id)">
