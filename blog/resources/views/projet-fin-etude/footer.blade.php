...
<div class="container-fluid " style="background-color:#1C2833;color: white; width: 100%;">
  ...
  <div id="hiddenFooter">
    ...
    <div class="col-md-2 w3-right">
      <strong style="color: #fcba03;font-family: Times New Roman,Times,serif;">Inscrivez-vous a nos Newsletters</strong><br><br>
      <input type="email" name="Subcribe" placeholder="Entrer votre email" class="form-control" required=""><button class="w3-light-blue">Envoyer</button>
    </div>
</div>
</div>